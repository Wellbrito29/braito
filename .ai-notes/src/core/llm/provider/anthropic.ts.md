# src/core/llm/provider/anthropic.ts
...
| Type | Detail |
|------|--------|
| code | Exported symbols: AnthropicProvider |
| graph | Consumed by: /home/runner/work/braito/braito/src/core/llm/provider/factory.ts |
