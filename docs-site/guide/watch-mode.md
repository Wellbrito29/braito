...
- Combined with the [Web UI](/guide/web-ui): open `http://localhost:7842` in another terminal and reload to see updated notes.
- Combined with the [MCP server](/guide/mcp-server): your AI assistant always has current context.
