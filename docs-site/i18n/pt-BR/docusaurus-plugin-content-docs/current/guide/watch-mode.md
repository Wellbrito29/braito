...
- Combinado com a [Interface Web](./web-ui): abra `http://localhost:7842` em outro terminal e recarregue para ver as notas atualizadas.
- Combinado com o [Servidor MCP](./mcp-server): seu assistente de IA sempre tem contexto atual.
